...
export const functions = {
  invoke: async (name, data) => {
    const map = {
      generateReferralCode:  () => get('/api/referral/my-code'),
      applyReferralCode:     () => post('/api/referral/apply', data),
      ...
      useStreakFreeze:        () => post('/api/gamification/freeze'),
      checkBadges:           () => post('/api/gamification/check-badges'),
      getPractitionerDashboard: () => get('/api/practitioner/dashboard'),
      getPractitionerClients:   () => get('/api/practitioner/clients'),
      inviteClient:          () => post('/api/practitioner/invite', data),
